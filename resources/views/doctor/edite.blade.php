...
<body>
    ...
    <form action="{{ route('updateProfile') }}" method="POST">
        ...
        <button type="submit" style="background-color: #1a68b3; transform: translate(1500%, -90%); padding-top: 8px ; font-size:25px ; color:white;" class="btn"> <a href="{{ route('profile') }}">Save</a></button>
    </form>
</body>
</html>
