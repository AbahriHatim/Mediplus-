...
<body>
    ...
    <a href="{{ route('editProfile') }}"><button style="background-color: #1a68b3; transform: translate(1500%, -90%); padding-top: 8px ; font-size:25px ; color:white;" class="btn">Edite</button></a>
</body>
</html>