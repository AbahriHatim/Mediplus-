...
<body>
    ...
    <section>
                    ...
                    <div class="col-lg-4" >
                      <div class="card shadow-sm" style= "background-color:aliceblue;" >
                        ...
                        <div class="card-body">
                          ...
                          <p class="mb-0">
                            <strong class="pr-1">Phone:</strong>{{ $patient->phone
                            }}
                          </p>
                        </div>
                      </div>
      ...
      <a href="{{ route('editProfilePa') }}"><button style="background-color: #1a68b3; transform: translate(1400%, -90%); padding-top: 8px ; font-size:25px ; color:white;" class="btn">Edite</button></a>
