...
<body>
    ...
    <section>
                    ...
                    <div class="col-lg-4" >
                      <div class="card shadow-sm" style= "background-color:aliceblue;" >
                        ...
                        <div class="card-body">
                          ...
                          <p class="mb-0">
                            <strong class="pr-1">Specialization:</strong>{{
                            $doctor->specialization }}
                          </p>
                          <p class="mb-0">
                            <strong class="pr-1">Phone:</strong>{{ $doctor->phone
                            }}
                          </p>
                        </div>
                      </div>
      ...
      <a href="{{ route('DoctorListPa') }}"><button style="background-color: #1a68b3; transform: translate(1200%, -90%); padding-top: 8px ; font-size:25px ; color:white;" class="btn">Retour</button></a>
