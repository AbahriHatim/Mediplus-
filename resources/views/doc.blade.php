    ...
    <div class="formbold-main-wrapper">
        <div class="formbold-form-wrapper">
            ...
            <form action="{{ route('insertDetails') }}" method="POST"  >
                ...
                <!-- Specialization -->
                <div class="formbold-mb-3">
                    <label for="specialization" class="formbold-form-label">{{ __('Specialization') }}</label>
                    <select id="specialization" class="formbold-form-input block mt-1 w-full" name="specialization">
